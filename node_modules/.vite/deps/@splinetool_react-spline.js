...
import {
  ...
  h,
  r
} from "./chunk-H6CEBTZ4.js";
import {
  u
} from "./chunk-2ZQ7JVX6.js";
import "./chunk-JZWQ2H2N.js";
import {
  f,
  p as p2,
  v,
...
import "./chunk-MZZ2XZN3.js";
import "./chunk-KT6PNQOJ.js";
import {
  X
} from "./chunk-XUL2VAUX.js";
import "./chunk-AXY3SIRC.js";
import {
  B,
  j,
  w
} from "./chunk-MBIFB4W7.js";
import "./chunk-53XVISTZ.js";
import "./chunk-JMJSRYJY.js";
import "./chunk-6BSVDP3P.js";
import {
  A,
  E as E2,
  O,
  w as w3
} from "./chunk-LJSKCYEH.js";
import "./chunk-TVZXKFID.js";
import {
  m
} from "./chunk-5IXFV5KU.js";
...
import {
  a,
  r as r2
} from "./chunk-HGU3ZNVU.js";
import {
  zt
} from "./chunk-XM6QDFGQ.js";
import {
  e,
  s
...
var Ut = class {
  ...
  static isHandledMethod(e4, t4) {
    return vt(e4) ? Tt.isHandledMethod(t4) : dt(e4) ? Rt.isHandledMethod(t4) : e4 instanceof Set ? Vt.isHandledMethod(t4) : e4 instanceof Map ? Lt.isHandledMethod(t4) : ht(e4);
  }
  get isCloning() {
  ...
  start(e4, t4, n3) {
    let i2 = Tt;
    dt(e4) ? i2 = Rt : e4 instanceof Date ? i2 = Dt : e4 instanceof Set ? i2 = Vt : e4 instanceof Map ? i2 = Lt : e4 instanceof WeakSet ? i2 = It2 : e4 instanceof WeakMap && (i2 = Gt2), this._stack.push(new i2(e4, t4, n3, this._hasOnValidate));
  }
  update(e4, t4, n3) {
...
var Kt = Nt;
var Ft2 = "__splineHtmlContent";
var zt2 = `(function () {
	'use strict';
	var MARKER = ${JSON.stringify(Ft2)};
	var callSeq = 1;
	var pending = {};
	var listeners = {};
	var acked = false;
...
var qt = class {
  constructor(e4, t4, n3) {
    this.iframe = e4, this.deps = t4, this.onConsole = n3, this.disposed = false, this.handshakeSeen = false, this.handshakeTimer = null, this.onMessage = (e5) => {
      ...
      let t5 = e5.data;
      var n4;
      "object" != typeof (n4 = t5) || null === n4 || true !== n4[Ft2] || "string" != typeof n4.kind || this.handleMessage(t5);
    }, this.host = new Wt(t4, n3, (e5, t5) => {
      this.sendEvent(e5, t5);
    });
  }
  attach() {
    window.addEventListener("message", this.onMessage), this.send({ [Ft2]: true, kind: "ready-ack" }), this.handshakeTimer = window.setTimeout(() => {
  ...
  handleMessage(e4) {
    switch (e4.kind) {
      case "ready":
        this.handshakeSeen = true, this.send({ [Ft2]: true, kind: "ready-ack" });
        break;
      case "console":
      ...
      case "call": {
        ...
        t4.then((t5) => {
          this.send({ [Ft2]: true, kind: "result", id: e4.id, ok: true, value: t5, error: void 0 });
        }, (t5) => {
          let n3 = t5 instanceof Error ? t5.message : String(t5);
          this.send({ [Ft2]: true, kind: "result", id: e4.id, ok: false, value: void 0, error: n3 }), this.onConsole("error", n3);
        });
        break;
      }
      case "input":
  ...
  sendEvent(e4, t4) {
    this.send({ [Ft2]: true, kind: "event", eventName: e4, payload: t4 });
  }
  dispatchInput(e4) {
...
var Zt2 = new Ki();
function Jt2(e4) {
  return Xt3.setFromArray(e4), Xt3.getSize(Zt2), { width: Zt2.x, height: Zt2.y, depth: Zt2.z };
}
var Qt2 = class {
...
function vn(e4) {
  return mn || (mn = import("./runtime-DRACOLoader-5OLRBTT3-SMHLSACP.js").then(({ DRACOLoader: t4 }) => ((pn = new t4()).setDecoderPath(void 0 !== e4 ? `${e4}/` : "https://www.gstatic.com/draco/versioned/decoders/1.5.2/").preload(), pn.decoderPending))), mn;
}
...
var _n = { bloom: () => import("./runtime-bloom-XL2LGMRS-YBQ7S2NL.js"), chromaticAberration: () => import("./runtime-chromaticAberration-G6RI2BZ6-I55MMKRU.js"), vignette: () => import("./runtime-vignette-TECYHVQU-TPCS4IYP.js"), noise: () => import("./runtime-noise-PNVGOS7A-GMQPMUDB.js"), hueSaturation: () => import("./runtime-hueSaturation-LYCL2TIK-ELTH45JG.js"), brightnessContrast: () => import("./runtime-brightnessContrast-NVUYXHJN-WE3OHZJX.js"), depthOfField: () => import("./runtime-depthOfField-UOGP3RXR-27IQUNMW.js"), pixelation: () => import("./runtime-pixelation-ZVCDH6UI-DBZJHGNK.js") };
var jn = { bloom: () => import("./runtime-fxBloom-7MH75D7M-DLYCEVUL.js"), depthOfField: () => import("./runtime-fxDepthOfField-TFTNDBM5-FLTLB2GD.js") };
...
var kn = class {
  ...
  static mount(e4, t4, n3, i2) {
    ...
    l2.observe(t4), l2.observe(s6), r5.srcdoc = (function(e5) {
      let t5 = `<script>${zt2}<\/script>`, n4 = /<head(\s[^>]*)?>/i.exec(e5);
      if (n4) {
...
var Tn = "data-spline-html-content";
var Rn = `
...
var Dn = class {
  ...
  static mount(e4, t4, n3, i2) {
    ...
    c2.textContent = Rn, r5.appendChild(c2);
    ...
    let u2 = /* @__PURE__ */ new Map(), p3 = new Wt(Sn(e4, t4, i2), (e5, t5) => {
      "warn" === e5 ? console.warn(`[spline html] ${t5}`) : "error" === e5 && console.error(`[spline html] ${t5}`);
    }, (e5, t5) => {
      let n4 = u2.get(e5);
...
var Fn = { Empty: "Group", PointLight: "Point Light", SpotLight: "Spot Light", DirectionalLight: "Directional Light" };
function zn(e4, t4) {
  return void 0 === e4 ? [t4[0], t4[1], t4[2]] : Array.isArray(e4) ? [e4[0] ?? t4[0], e4[1] ?? t4[1], e4[2] ?? t4[2]] : [e4.x ?? t4[0], e4.y ?? t4[1], e4.z ?? t4[2]];
}
function Wn(e4) {
  return "number" == typeof e4 ? [e4, e4, e4] : zn(e4, [1, 1, 1]);
}
function Hn(e4) {
...
function Jn(e4, t4, n3) {
  ...
  a2.visible = t4.visible ?? true, a2.position = zn(t4.position, [0, 0, 0]), a2.rotation = zn(t4.rotation, [0, 0, 0]), a2.scale = Wn(t4.scale);
  let o4 = (s6 && Kn[s6]) ?? Fn[i2] ?? i2;
...
var li = class {
  ...
  async _createRenderer() {
    ...
    if ("webgpu" === this._rendererBackend) try {
      let { createWebGPUSplineRenderer: e4, isWebGPUSupported: t4 } = await import("./runtime-webgpu-TT4HHDA7-5JDLB33J.js");
      t4();
    ...
    {
      let { SplineRenderer: e4, rendererGlobals: t4 } = await import("./runtime-classicRuntime-GZEGVJ7B-TAW3JEFC.js");
      try {
  ...
  async start(e4, { interactive: t4 = true, variables: n3 } = {}) {
    ...
    let r5 = await (async function(e5) {
      ...
      if (131 !== (t5.schema ?? 0)) {
        let { updateDocumentSchema: e6 } = await import("./runtime-updater-QYT2D73O-MZPB7S4F.js");
        e6(t5);
      }
    ...
    r5.version && (0, Cn.default)(r5.version, "2.0.52") > 0 && console.warn("Your .splinecode file is more recent than the library. Please upgrade @splinetool/runtime to the latest version."), void 0 !== this._wasmPath && (this.setUIWasmUrl(`${this._wasmPath}/hana-ui.wasm`), r4(this._wasmPath));
    let l2 = (async function(e5) {
      {
        let t5 = { particles: () => import("./runtime-particles-F5MUJ3SG-OTCWHJD3.js"), hair: () => import("./runtime-hair-BMIXD4DE-7Q2EQWKO.js"), "shape-blends": () => import("./runtime-shapeBlends-A75ALCPS-QHJ5PW7M.js"), "vector-shapes": () => import("./runtime-vectorShapes-NAOKPPYS-HJO2FKKY.js"), "3d-paths": () => import("./runtime-paths-4JBIN2NB-D67P7ZDO.js"), cloners: () => import("./runtime-cloners-7SKK4ILD-4YI4NOPZ.js"), components: () => import("./runtime-components-QFBU6NQX-4JTV4PJK.js"), text: () => import("./runtime-text-WPZBMBKI-DNJ6OO4Z.js"), "ui-2d": () => import("./runtime-ui2d-OSYYZANY-T5K7G22X.js"), "game-controls": () => import("./runtime-gameControls-JQ3GPIIQ-R2LK7PCE.js"), "collision-bvh": () => import("./runtime-collisionBVH-CQUE6RZV-FZBWUZSO.js"), mousehover: () => import("./runtime-mouseHover-Y2BARDNH-GKF4PE5Y.js"), scroll: () => import("./runtime-scroll-W3ACRLD3-RMK7IOFK.js"), dragdrop: () => import("./runtime-dragDrop-MCBED4HC-OHWEJRTB.js"), tracking: () => import("./runtime-tracking-N5EXAGD3-DL474X7G.js"), resize: () => import("./runtime-resize-C4J5X2UE-6ILBVDEM.js"), conditional: () => import("./runtime-conditional-XSJDNYMV-HWX3NB7P.js"), variables: () => import("./runtime-variables-PI7YVOVR-QGNHGFTF.js"), "api-services": () => import("./runtime-apiServices-TWKYVKXK-3TUXURZ2.js"), "ai-assistant": () => import("./runtime-aiAssistant-Q7WOWTCF-RSPY4PJK.js"), textinputs: () => import("./runtime-textInputs-2ZNTJL63-VJXU3YLB.js"), audio: () => import("./runtime-audio-EAVYJJ6Y-6EMYQ37U.js"), video: () => import("./runtime-video-5C4ZCNVD-H4O6DU45.js"), "create-destroy": () => import("./runtime-createDestroy-4AEFZQ6Z-BSAIWWRU.js"), "scene-transition": () => import("./runtime-sceneTransition-ZACN3VBY-A5M6XY4M.js"), timeline: () => import("./runtime-timeline-FQBHGQWZ-FTJEUHVY.js"), transitions: () => import("./runtime-transitions-YUNUNEOJ-X7N7QUCF.js"), "misc-actions": () => import("./runtime-miscActions-HPVTGVUE-OUWBHX3I.js") }, n4 = (function(e6) {
          var _a2, _b2;
    ...
    await Promise.all([l2, o4.length && vn(this._wasmPath), w(r5) && zt(this._wasmPath), m(r5) && Wi(this._wasmPath), ua.physicsEnabled(r5.scene.objects) && lt(this._wasmPath), Ae(r5) && o2(), Ft(r5) && Xt2(), r2(r5) && a(), e3(r5) && l2.then(() => {
      var _a2;
    ...
    if ("webgpu" === this._rendererBackend) try {
      await Promise.all([import("./runtime-webgpu-TT4HHDA7-5JDLB33J.js"), (p3 = h3, Pn(p3, jn, "webgpu"))]), this._renderer || (this._renderer = await this._createRenderer());
    } catch (e5) {
      console.error("[spline] Failed to load the WebGPU material backend, using WebGL:", e5), this._rendererBackend = "webgl";
    }
    var p3;
    "webgpu" !== this._rendererBackend && await Promise.all([import("./runtime-classicRuntime-GZEGVJ7B-TAW3JEFC.js"), Mn(h3)]), Yt2("webgpu" === this._rendererBackend ? "webgpu" : "webgl");
    let m3 = new fn(r5);
    if (m3.resetPersonalCameraFromDocumentData(), this._scene = m3.scene, this._sharedAssetsManager = m3.sharedAssets, this._camera = this._scene.activeCamera, window.location.search.includes("merge-geometries")) {
      let { mergeStaticGeometries: e5 } = await import("./runtime-mergeStaticGeometries-OFAAEYTX-72R2AFVZ.js"), t5 = performance.now();
      e5(r5, m3.scene);
    ...
    }), Ae(r5) && Gt(r5) && await Promise.all(y2), e3(r5)) {
      let e5 = [];
  ...
  async createCustomMaterial(e4) {
    ...
    let t4 = ri();
    if (void 0 === t4 && ("webgpu" === this._rendererBackend && (await import("./runtime-webgpu-TT4HHDA7-5JDLB33J.js"), t4 = ri()), void 0 === t4)) throw new Error("createCustomMaterial: requires the webgpu backend (the runtime default where WebGPU is available). This Application is on the classic WebGL pipeline — pass { renderer: 'webgpu' } or drop any ?renderer=webgl2 override.");
    let n3 = e4(t4);
  ...
  async createObject(e4, t4 = {}) {
    ...
    if ("TextGeometry" === s6.geometryType) {
      if (await import("./runtime-text-WPZBMBKI-DNJ6OO4Z.js"), !t2("text")) throw new Error("createObject: this runtime build was compiled without the 'text' feature — re-export the scene with a Text object present, or load the full runtime build.");
  ...
  cloneObject(e4, t4 = {}) {
    ...
    let o4 = (function(e5, t5, n4) {
      let i3 = { ...e5.data };
      return void 0 !== t5.position && (i3.position = zn(t5.position, [0, 0, 0])), void 0 !== t5.rotation && (i3.rotation = zn(t5.rotation, [0, 0, 0])), void 0 !== t5.scale && (i3.scale = Wn(t5.scale)), void 0 !== t5.visible && (i3.visible = t5.visible), i3.name = t5.name ?? Qn(`${e5.data.name ?? "Object"} Copy`, n4), { ...e5, data: i3 };
