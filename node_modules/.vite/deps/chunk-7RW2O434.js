...
// node_modules/@splinetool/runtime/build/runtime-chunk-7AY2FNTL.js
var A = 200;
var W = null;
function O2(t3) {
  W = t3;
...
function lt(t3) {
  return rt || (rt = (async function() {
    let e3 = t3 ?? "https://cdn.spline.design/@splinetool/runtime@2.0.52/build", i = import("./physics-XSCNPI7S.js"), [s3, o3] = await Promise.all([i, fetch(`${e3}/physics.wasm`).then((t4) => t4.arrayBuffer())]);
...
var Lt = (t3) => t3.states.some((t4) => void 0 !== t4.data.position || void 0 !== t4.data.rotation || void 0 !== t4.data.hiddenMatrix || void 0 !== t4.data.cloner || void 0 !== t4.data.pathSnapping);
function Bt(t3) {
...
var It = class {
  ...
  initBVH() {
    ...
    if (this.page.traverseChildren((t3) => {
      ...
      if (Lt(n4) || l || d || s3.dataPatched.events.some((t4) => true !== t4.data.disabled && ("GameControl" === t4.data.type || "Follow" === t4.data.type))) return t3.updateMatrixWorldRigid(), this.addBoundsTree(t3), true;
      if (h) {
  ...
  initPhysics() {
    ...
    if (this.page.traverseChildren((i2) => {
      ...
      let n4 = Lt(a3), h = false, l = s4.userData.hasDestroy, d = s4.userData.hasDrag, c2 = false;
...
function kt(t3) {
  return Ot || (Ot = (async function() {
    let e3 = t3 ?? "https://cdn.spline.design/@splinetool/runtime@2.0.52/build";
    typeof window < "u" && (Wt = new URL(e3.endsWith("/") ? e3 : `${e3}/`, window.location.href).href);
    let i = import("./navmesh-MY7B3ETU.js"), [s3, o3] = await Promise.all([i, fetch(`${e3}/navmesh.wasm`).then((t4) => t4.arrayBuffer())]), a2 = s3.default, n4 = await a2({ wasmBinary: o3 });
    At(n4);
  })());
}
...
//# sourceMappingURL=chunk-7RW2O434.js.map
