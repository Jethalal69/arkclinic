...
// node_modules/@splinetool/runtime/build/runtime-chunk-5KBBYU4N.js
var b = new As();
var A = new As();
var M = new As();
var S = new As();
...
var x = new Float32Array(0);
function O(e, t, s3, o) {
  let r = 16 * (t.children.length + 1);
  x.length < r && (x = new Float32Array(r));
  let i2 = 0, a = (e2) => {
    e2.toArray(x, 16 * i2), i2++;
  ...
  try {
    return 0 === i2 ? 0 : Qt(s3, x.subarray(0, 16 * i2));
  } finally {
    Zt(s3);
  }
}
...
//# sourceMappingURL=chunk-MBIFB4W7.js.map
