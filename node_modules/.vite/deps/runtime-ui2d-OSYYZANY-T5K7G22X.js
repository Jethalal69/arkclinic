...
// node_modules/@splinetool/runtime/build/runtime-ui2d-OSYYZANY.js
...
var G = new to({ defines: {}, uniforms: { tDiffuse: new Fl(null) }, vertexShader: "\n	varying vec2 vUv;\n	void main() {\n		vUv = uv;\n		gl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );\n	}", fragmentShader: "\n	uniform sampler2D tDiffuse;\n	varying vec2 vUv;\n	void main() {\n		vec4 texel = texture2D( tDiffuse, vUv );\n		gl_FragColor = texel;\n	}" });
var U2 = new class {
  constructor(e2) {
...
var C = class {
  constructor(t, i2, r, s) {
    ...
    }, this.scene2d = new K(Zi.generateUUID(), j.defaultData, { dpr: window.devicePixelRatio, shared: s.shared }), this.canvas = (null === z && (z = document.createElement("canvas")), z), this.renderer = (n = this.canvas, null === k && (k = new ht(n)), k), this.promise = this.init(), this.renderTarget = new Ms(1, 1, { type: Tt, stencilBuffer: false, depthBuffer: false }), s.shared.addUIBuffer(this.uuid, this.renderTarget), this.textureHolder = s.shared.uiBuffer(this.uuid);
  }
  get canvasTexture() {
  ...
  render(e2) {
    ...
    if (this.isFrameDirty) {
      if (this.isFrameDirty = false, this._innerApplySize(), this.renderer.clear(), (_a = this.frameOverride) == null ? void 0 : _a.draw(this.renderer), this.renderer.render(), this.canvasTexture.needsUpdate = true, e2.blitTextureToTarget) e2.blitTextureToTarget(this.canvasTexture, this.renderTarget);
        ...
        G.uniforms.tDiffuse.value = this.canvasTexture;
        let t = e2.getRenderTarget();
        e2.setRenderTarget(this.renderTarget), e2.clear(), U2.render(e2), e2.setRenderTarget(t);
      }
  ...
  applyOverrides(e2) {
    if (this.frameOverride && this.frameRoot) {
      ...
      this.frameOverride.width = t, this.frameOverride.height = i2, this.frameOverride.localMatrix = _2, this.isScreenSpace && (this.frameOverride.fill.color = wt.from0to1([0, 0, 0, 0])), this.frameOverride.data = { ...this.frameOverride.data, width: t, height: i2 }, L({ objectOverride: this.frameOverride, objectRoot: this.frameRoot, newParentWidth: this.frameOverride.width, newParentHeight: this.frameOverride.height, initialParentWidth: this.frameRoot.width, initialParentHeight: this.frameRoot.height }), this.frameOverride.updateWorldMatrix(true, false, true);
    }
  }
...
function V3({ objectOverride: e2, objectRoot: t, newParentWidth: i2, newParentHeight: r, initialParentWidth: a2, initialParentHeight: s }) {
  let [n, h] = (function(e3) {
    if (q(e3)) return [e3.width, e3.height];
    if (e3 instanceof $) {
  ...
  if (e2.position = p2, e2.data = { ...e2.data, position: p2 }, e2.states) for (let n2 in e2.states) A({ stateId: n2, objectOverride: e2, objectRoot: t, newParentWidth: i2, newParentHeight: r, initialParentWidth: a2, initialParentHeight: s });
  if (q(e2) || e2 instanceof W) q(e2) && (e2.width = o, e2.height = u, e2.data = { ...e2.data, width: o, height: u }), L({ objectOverride: e2, objectRoot: t, newParentWidth: o, newParentHeight: u, initialParentWidth: n, initialParentHeight: h });
  else if (e2 instanceof $) {
    let i3 = t, r2 = 0 !== n ? o / n : 1, a3 = 0 !== h ? u / h : 1;
    e2.path = Q(i3.path, r2, a3), e2.data = { ...e2.data, path: e2.path };
  }
}
function A({ stateId: e2, objectOverride: t, objectRoot: i2, newParentWidth: r, newParentHeight: a2, initialParentWidth: s, initialParentHeight: n }) {
  var _a, _b;
...
var N2 = class extends cr {
  constructor(e2, t, i2) {
    super(e2, t, i2), this.isUIObject = true, this.uiCanvas = new C(e2 + "-canvas", t.geometry.width, t.geometry.height, i2), this.uiCanvas.promise.then(() => {
...
i("UIGeometry", (e2, t, i2) => new N2(e2, t, i2)), p({ Scene2D: K, UICanvas: C, loadHanaUIRUNTIME: v, setHanaUIWasmUrl: y }), a("ui-2d");
//# sourceMappingURL=runtime-ui2d-OSYYZANY-T5K7G22X.js.map
