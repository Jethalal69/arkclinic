...
// node_modules/@splinetool/runtime/build/runtime-classicRuntime-GZEGVJ7B.js
var Ui = class {
  constructor(e2) {
...
function qo(e2, t3) {
  ...
  V3[e2.TEXTURE_2D] = B2(e2.TEXTURE_2D, e2.TEXTURE_2D, 1), V3[e2.TEXTURE_CUBE_MAP] = B2(e2.TEXTURE_CUBE_MAP, e2.TEXTURE_CUBE_MAP_POSITIVE_X, 6), V3[e2.TEXTURE_2D_ARRAY] = B2(e2.TEXTURE_2D_ARRAY, e2.TEXTURE_2D_ARRAY, 1, 1), V3[e2.TEXTURE_3D] = B2(e2.TEXTURE_3D, e2.TEXTURE_3D, 1, 1), n3.setClear(0, 0, 0, 1), i3.setClear(1), a4.setClear(0), H3(e2.DEPTH_TEST), i3.setFunc(U), j3(false), $2(s), H3(e2.CULL_FACE), X2(p);
  ...
  return { buffers: { color: n3, depth: i3, stencil: a4 }, enable: H3, disable: G2, bindFramebuffer: function(t4, n4) {
    ...
    let a5 = N2[i4];
    void 0 === a5 && (a5 = { type: void 0, texture: void 0 }, N2[i4] = a5), (a5.type !== t4 || a5.texture !== n4) && (U2 !== i4 && (e2.activeTexture(i4), U2 = i4), e2.bindTexture(t4, n4 || V3[t4]), a5.type = t4, a5.texture = n4);
    ...
    if (t4.samples > 0) {
      if (false === G2(t4)) {
        ...
        for (let n4 = 0; n4 < a5.length; n4++) {
          ...
          e2.blitFramebuffer(0, 0, r3, o3, 0, 0, r3, o3, s4, e2.NEAREST), true === c3 && (B2.length = 0, V3.length = 0, B2.push(e2.COLOR_ATTACHMENT0 + n4), t4.depthBuffer && false === t4.resolveDepthBuffer && (B2.push(l3), V3.push(l3), e2.invalidateFramebuffer(e2.DRAW_FRAMEBUFFER, V3)), e2.invalidateFramebuffer(e2.READ_FRAMEBUFFER, B2));
        }
  ...
  constructor(e2 = {}) {
    ...
    this.xr = ze, this.getContext = function() {
      ...
      let o3 = a5.isMesh && a5.matrixWorld.determinantAffine() < 0, s4 = (function(e4, t5, n5, i5, a6) {
        ...
        if (_3.needsLights && (S3.state.directionalShadowMap.length > 0 && A3.setValue(Ne, "directionalShadowMap", S3.state.directionalShadowMap, fe2), S3.state.spotShadowMap.length > 0 && A3.setValue(Ne, "spotShadowMap", S3.state.spotShadowMap, fe2), S3.state.pointShadowMap.length > 0 && A3.setValue(Ne, "pointShadowMap", S3.state.pointShadowMap, fe2)), a6.isSkinnedMesh) {
    ...
    function Je(e3, t4, n4, i4) {
      ...
      M2.setRenderTarget(a5), M2.getClearColor(B2), V3 = M2.getClearAlpha(), V3 < 1 && M2.setClearColor(16777215, 0.5), M2.clear(), ne3 && ye2.render(n4);
      ...
      M2.setRenderTarget(s4, l3, c4), M2.setClearColor(B2, V3), void 0 !== u4 && (i4.viewport = u4), M2.toneMapping = d3;
    }
...
var Ec = class extends Fi {
  constructor(e2, t3) {
    super(), this._needsDOFResize = t3, this.postprocessingState = Pr.defaultData, this._scene = new hr(), this._camera = new V2(), this.effects = /* @__PURE__ */ new Map(), this.blueNoiseTexture = new Qa(), this._renderToScreen = true, this._isUIOverlayEnabled = false, this.timer = new bl(), this.renderer = e2, this.debug = false;
...
var Cc = class extends ns {
  constructor(t3) {
    super(t3), this._pixelRatio = this.getPixelRatio(), this.viewportWidth = 1, this.viewportHeight = 1, this.resolution = new Gi(), this.dummyCamera = new V2(), this.sceneTransitionDuration = 0, this.sceneTransitionTimeRemaining = -1, this.manageShadowUpdates = false, this.forceShadowUpdates = false, this.clear = (e2 = true, t4 = true, n4 = true) => {
  ...
  renderNormal(e2, t3, n3) {
    if (this.normalRenderTarget) {
      ...
      }), this.setRenderTarget(this.normalRenderTarget), this.clear(), Zl.value = n3 instanceof V2 ? (n3.far - n3.near) / 1e4 : 1;
  ...
  renderSplineScene(e2, t3, { sceneHelpers: a4 = this.sceneHelpers, sceneHelpersOnTop: o2 = this.sceneHelpersOnTop, overrideTransmission: u3, overrideNormal: f3 } = {}) {
    ...
    }), this.manageShadowUpdates && (this.shadowMap.autoUpdate = false, (m2.shadowsDirty || this.forceShadowUpdates) && (this.shadowMap.needsUpdate = true)), p2.overrideMaterial = m2.wireframeState ? xe2 : null, this.pipeline.render(), this.manageShadowUpdates && (m2.shadowsDirty = false), Zs.taaEnabled.value && (Zs.frameIndex.value = (Zs.frameIndex.value + 1) % 16), t3 instanceof V2 && t3.copyHistory(), p2.visible = h3;
  }
...
//# sourceMappingURL=runtime-classicRuntime-GZEGVJ7B-TAW3JEFC.js.map
