...
// node_modules/@splinetool/runtime/build/runtime-chunk-X6BELYL5.js
var l = new Ki();
function u(e2, t, s2 = false) {
  ...
  let i = [], c = (a) => {
    ...
    for (let e3 of s3.states) {
      let t2 = { ...e3.data };
      a.states || (a.states = {}), a.states[e3.id] = p.patch(s3, t2);
    }
    p2(e2.scene, a, null, t, void 0 !== s3.events.find((e3) => "Follow" === e3.data.type || "LookAt" === e3.data.type)), f(e2);
  };
  e2.scene.traverse2D(c), e2.traverseChildren((r2) => {
    ...
    p2(e2.scene, r2, null, t, void 0 !== f2.events.find((e3) => "Follow" === e3.data.type || "LookAt" === e3.data.type)), s(r2) && r2.frame && (r2.frame.traverse((e3) => c(e3)), (_f = r2.uiCanvas) == null ? void 0 : _f.applySize());
...
function p2(a, o, r2, n, d = false) {
  if (a.markShadowsDirty(), o instanceof cr && !e(o) && o.removeInteractionGeometry(n), r(o) ? o.changeSelectedState(r2, { shared: n }, d) : o.changeSelectedState(r2, { scene: a, shared: n }, d), o instanceof cr && o.updateGeometryGroupsIfNeeded(), o instanceof V && o.updateCameraState(o.dataPatched, { scene: a, shared: n }), !r(o)) {
    if (o.cloner) {
      let e2 = false;
...
//# sourceMappingURL=chunk-2ZQ7JVX6.js.map
