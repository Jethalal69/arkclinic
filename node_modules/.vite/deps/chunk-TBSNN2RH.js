...
// node_modules/@splinetool/runtime/build/runtime-chunk-M3IGVAW7.js
var c;
var p3;
var f;
var x = b((t, e) => {
  ...
  !(function(t2, e2) {
    ...
    var r, s = {}, n2 = { svg_path: xt2 }, a2 = xt2, h = function(t3) {
    ...
    }, P2 = /^[Qq]/, R2 = ut2(["Q", "q"], false, false), z2 = function(t3, e3) {
      ...
      return t3.join("");
    }, $2 = ".", G2 = dt2(".", false), Q2 = /^[eE]/, Z2 = ut2(["e", "E"], false, false), J2 = /^[+\-]/, K2 = ut2(["+", "-"], false, false), tt2 = /^[0-9]/, et2 = ut2([["0", "9"]], false, false), it2 = function(t3) {
      return t3.join("");
    ...
    function mt2() {
      ...
      return c2.test(t2.charAt(nt2)) ? (i2 = t2.charAt(nt2), nt2++) : (i2 = s, 0 === lt2 && ft2(p4)), i2 !== s && (i2 = f2()), (e3 = i2) === s && (e3 = (function() {
        ...
        var e4, i3, r2, n3;
        if (e4 = nt2, P2.test(t2.charAt(nt2)) ? (i3 = t2.charAt(nt2), nt2++) : (i3 = s, 0 === lt2 && ft2(R2)), i3 !== s) {
          for (r2 = [], n3 = Ot(); n3 !== s; ) r2.push(n3), n3 = Ot();
          r2 !== s ? (n3 = (function() {
            var t3, e5, i4, r3, n4, a3;
            if (t3 = nt2, (e5 = St()) !== s) {
    ...
    function St() {
      var t3, e3, i2, r2;
      return t3 = nt2, (e3 = bt()) !== s ? ((i2 = At()) === s && (i2 = null), i2 !== s && (r2 = bt()) !== s ? t3 = e3 = z2(e3, r2) : (nt2 = t3, t3 = s)) : (nt2 = t3, t3 = s), t3;
    }
    function Bt() {
    ...
    function Ct() {
      var t3, e3, i2;
      return t3 = nt2, (e3 = zt()) === s && (e3 = null), e3 !== s && (i2 = Pt()) !== s ? t3 = e3 = [e3, i2] : (nt2 = t3, t3 = s), t3 === s && (t3 = nt2, (e3 = zt()) === s && (e3 = null), e3 !== s && (i2 = Et()) !== s ? t3 = e3 = [e3, i2] : (nt2 = t3, t3 = s)), t3 !== s && (t3 = j2(t3)), t3;
    }
    function kt() {
      var e3;
    ...
    function Pt() {
      ...
      })(), i2 !== s ? ((r2 = Rt()) === s && (r2 = null), r2 !== s ? e3 = i2 = [i2, r2] : (nt2 = e3, e3 = s)) : (nt2 = e3, e3 = s), e3 === s && (e3 = nt2, (i2 = Et()) !== s && (r2 = Rt()) !== s ? e3 = i2 = [i2, r2] : (nt2 = e3, e3 = s)), e3 !== s && (e3 = Y3(e3)), e3;
    }
    function Rt() {
      var e3, i2, r2, n3;
      return e3 = nt2, Q2.test(t2.charAt(nt2)) ? (i2 = t2.charAt(nt2), nt2++) : (i2 = s, 0 === lt2 && ft2(Z2)), i2 !== s ? ((r2 = zt()) === s && (r2 = null), r2 !== s && (n3 = Et()) !== s ? e3 = i2 = [i2, r2, n3] : (nt2 = e3, e3 = s)) : (nt2 = e3, e3 = s), e3 !== s && (e3 = Y3(e3)), e3;
    }
    function zt() {
      var e3;
      return J2.test(t2.charAt(nt2)) ? (e3 = t2.charAt(nt2), nt2++) : (e3 = s, 0 === lt2 && ft2(K2)), e3;
    }
    function Et() {
      var e3, i2;
...
function v() {
  return c || (c = async () => (async function(t, e) {
    ...
    let t = typeof process < "u" ? "2.0.52" : void 0;
...
var z = class {
  constructor(e, i, r) {
    this.uuid = e, this.data = i, this.isObject2D = true, this.localMatrix = _.identity(), this.worldMatrix = _.identity(), this.ignoreCameraZoom = false, this.visible = true, this._singleBBox = new R(), this._recursiveBBox = new R(), this.singleBBoxNeedsUpdate = true, this.recursiveBBoxNeedsUpdate = true, this.stateSelection = null, this.prevState = null, this.currentState = null, this.reversibleToState = null, this.currentTransitionEvent = null, this.previousAction = null, this.name = "", this.position = [0, 0], this.scale = [1, 1], this.rotation = 0, this.shear = [0, 0], this.emitter = n(), this.dpr = r.dpr ?? 1, this.dataPatched = i;
  }
  project(t, e) {
  ...
  clone(t) {
    let e = new z(this.uuid, this.data, t);
...
function Q(t, e = 1, i = 1) {
  if (e <= 0 || i <= 0) return t;
  if (G(t)) return console.warn("Cannot scale invalid path", t), Z([]);
  if (1 === e && 1 === i) return t;
  try {
    return Z((0, X.parseSVG)(t).map((t2) => {
      let r = { ...t2 };
    ...
    return console.warn("Error parsing SVG path", t2), Z([]);
  }
}
function Z(t) {
...
var J = class {
  constructor(t, e, i) {
    this.uuid = t, this.data = e, this.group = new W(J.GROUP_ID, { ...k.defaultData }, i), this.createChildrenObjects(e.objects, this.group, i);
  }
...
function et(t, e, i, r, s, n2, a2, h, o, l) {
  ...
  let T3 = Math.max(1, Math.ceil(Math.abs(A2) / (Math.PI / 2))), P2 = A2 / T3, R2 = 4 / 3 * Math.tan(P2 / 4), z2 = k3, E2 = e, O2 = i;
  for (let e2 = 0; e2 < T3; e2++) {
    let e3 = z2 + P2, i2 = Math.cos(z2), n3 = Math.sin(z2), a3 = Math.cos(e3), h2 = Math.sin(e3), o2 = M2 + r * a3 * u - s * h2 * c2, l2 = C2 + r * a3 * c2 + s * h2 * u, d2 = -r * n3 * u - s * i2 * c2, p5 = -r * n3 * c2 + s * i2 * u, f3 = -r * h2 * u - s * a3 * c2, x3 = -r * h2 * c2 + s * a3 * u;
    t.push({ CurveTo: [{ x: E2 + R2 * d2, y: O2 + R2 * p5 }, { x: o2 - R2 * f3, y: l2 - R2 * x3 }, { x: o2, y: l2 }] }), z2 = e3, E2 = o2, O2 = l2;
  }
}
...
var ht = class {
  ...
  _applyClips(t, e = this._ctm) {
    ...
    for (let t2 of this._clips) {
      ...
      let k3 = (S3 - o) / s, A2 = (b3 - o) / s, T3 = (B2 - l) / h, P2 = (M2 - l) / h, R2 = Math.min(k3, A2), z2 = Math.min(T3, P2), E2 = Math.abs(A2 - k3), O2 = Math.abs(P2 - T3), [H2, F2, L2, U2] = C2.radii, N2 = R2 !== C2.x, j2 = z2 !== C2.y, I2 = R2 + E2 !== C2.x + C2.w, D2 = z2 + O2 !== C2.y + C2.h, W2 = Math.min(E2, O2) / 2;
      i = pt({ x: R2, y: z2, w: E2, h: O2, radii: [N2 || j2 ? 0 : Math.min(H2, W2), I2 || j2 ? 0 : Math.min(F2, W2), I2 || D2 ? 0 : Math.min(L2, W2), N2 || D2 ? 0 : Math.min(U2, W2)] }, 0);
    }
    return i;
  }
  drawText(t, e) {
...
//# sourceMappingURL=chunk-TBSNN2RH.js.map
