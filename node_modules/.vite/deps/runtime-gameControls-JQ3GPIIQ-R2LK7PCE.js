...
// node_modules/@splinetool/runtime/build/runtime-gameControls-JQ3GPIIQ.js
var N = (t, e) => {
  let i2 = e.x - t.x, o = e.y - t.y;
  return Math.sqrt(i2 * i2 + o * o);
};
var V2 = (t) => t * (Math.PI / 180);
...
at.prototype = new st(), at.constructor = at, at.id = 0, at.prototype.prepareNipples = function() {
  ...
  return n2.dataOnly || (Y(c.ui.el, s), Y(c.ui.front, c.frontPosition)), i2.nipples.push(c), i2.trigger("added " + c.identifier + ":added", c), i2.manager.trigger("added " + c.identifier + ":added", c), i2.bindNipple(c), c;
  ...
  return t = B(t), e.updateBox(), U(t, function(s) {
  ...
  if (((t2) => isNaN(t2.buttons) ? 0 !== t2.pressure : 0 !== t2.buttons)(t)) {
    ...
    })(h, s.position), p = V2(m), u = d / a3, y = { distance: d, position: h };
    if ("circle" === s.options.shape ? (l = Math.min(d, a3), c = ((t2, e2, i3) => {
      let o2 = { x: 0, y: 0 };
      return i3 = V2(i3), o2.x = t2.x - e2 * Math.cos(i3), o2.y = t2.y - e2 * Math.sin(i3), o2;
    ...
    s.frontPosition = { x: g, y: f }, i2.dataOnly || Y(s.ui.front, s.frontPosition);
    ...
    (v = s.computeDirection(v)).angle = { radian: V2(180 - m), degree: 180 - m }, s.trigger("move", v), e.trigger("move " + s.id + ":move", v);
...
function lt(t) {
  var e = this;
  e.ids = {}, e.index = 0, e.collections = [], e.scroll = Z(), e._windowBound = false, e.config(t), e.prepareCollections();
  var i2 = function() {
    var t2;
...
var Bt = class extends Fi {
  constructor(t, i2, o, s, n2, r2, a3, h, p) {
    ...
    if (this.object instanceof V && (this.object.matrixAutoUpdate = false), this.euler.setFromQuaternion(this.quaternion, "YXZ"), this.rotByTouch = o.rotByTouch ?? "joystick", this.rotBy = o.rotBy ?? "keys", this.rotationMode = o.rotationMode ?? "normal", this.moveMode = o.moveMode ?? "walk", this.collisionEnabled = o.collisionEnabled, this.speedTranslate = 1 * (o.speedTranslate ?? 250), this.speedOrbit = 0.025 * (o.speedRotate ?? 100), this.mouseOrbitSensitivity = 16e-6 * (o.speedRotate ?? 100), this.keyAssignments = o.keyAssignments.map((t2) => {
      let e = [t2[0], t2[1]];
  ...
  reset(t = false) {
    ...
    } else this.object instanceof V ? this.object.matrixAutoUpdate = true : this.object.updateMatrix();
  ...
  update(t) {
    ...
    if (jt2.setFromVector3(this.rot), "walk" === this.moveMode && (jt2.x = 0), n2.applyEuler(jt2), o && (St.setFromUnitVectors(At, this.groundNormal), n2.applyQuaternion(St)), true === this.usePhysics && this.object.rigidBody) {
      ...
      for (let i3 of this.sharedGameControlGlobals.entitiesWithTransformAnim) {
        ...
        (i3.hasNonUniformScale ? i3.matrixWorldRigid : i3.matrixWorld).decompose(zt, Wt2, Rt2);
        let o2 = this.object.getWorldPosition(Ft2).add(this.collider.position).sub(zt);
        Nt.copy(i3.prevQ).invert().premultiply(Wt2);
  ...
  collisionAdjustment(t) {
    ...
    this.sharedGameControlGlobals.entitiesWithTransformAnim.forEach((t2) => {
      ...
      Lt2.makeEmpty(), t2.updateMatrixWorldRigid();
      ...
      Lt2.expandByPoint(Vt.start), Lt2.expandByPoint(Vt.end), Lt2.min.addScalar(-this.collider.radius), Lt2.max.addScalar(this.collider.radius), t2.bvhGeometry.boundsTree.shapecast({ boundsTraverseOrder: (t3) => t3.distanceToPoint(Vt.end), intersectsBounds: (t3) => t3.intersectsBox(Lt2), intersectsTriangle: (t3) => {
    ...
    }), Lt2.makeEmpty(), Vt.copy(this.collider.segment), Vt.start.applyMatrix4(i2), Vt.end.applyMatrix4(i2), Lt2.expandByPoint(Vt.start), Lt2.expandByPoint(Vt.end), Lt2.min.addScalar(-this.collider.radius), Lt2.max.addScalar(this.collider.radius), (_a = this.sharedGameControlGlobals.staticMeshBVH) == null ? void 0 : _a.shapecast({ boundsTraverseOrder: (t2) => t2.distanceToPoint(Vt.end), intersectsBounds: (t2) => t2.intersectsBox(Lt2), intersectsTriangle: (t2) => {
...
Ft.then((t) => {
  Yt2 = t, Gt = new t.Vec3(), qt = new t.Vec3();
});
var Ut = new Ki();
var Kt2 = class {
  constructor(e = false, i2 = false) {
    ...
    this.usePhysics = e, this.isExport = i2, this.onPointerDown = (t) => {
      ...
      let h = Lt(a3), l = r2.userData.hasDestroy, c = r2.userData.hasDrag, d = false, m = false;
      ...
      if (Lt(a3) || l || c || r2.dataPatched.events.some((t) => true !== t.data.disabled && "GameControl" === t.data.type)) return true;
      h && e2.push(ct(h, s2.matrixWorld));
    }, this.navmeshWasm = Yt2, this.navMesh = new this.navmeshWasm.NavMesh(), this._workerURL = URL.createObjectURL(new Blob([(i2 ? (s = Wt ?? "https://cdn.spline.design/@splinetool/runtime@2.0.52/build/", `
(async function() {
...
`) : "\n(async function() {\n	const [wasmImport, wasmBinary] = await Promise.all([\n		import(self.location.origin + '/_libraries/navmesh.js'),\n		fetch(self.location.origin + '/_libraries/navmesh.wasm').then((res) => res.arrayBuffer()),\n	]);\n	const wasmModule = wasmImport.default;\n	self.module = await wasmModule({ wasmBinary });\n	postMessage('ready');\n})();\n") + "\n\nonmessage = function(messageEvent) {\n	const meshData = messageEvent.data;\n	const positions = meshData[0];\n	const offset = meshData[1];\n	const indices = meshData[2];\n	const indicesLength = meshData[3];\n	const parameters = meshData[4];\n\n	const module = self.module;\n	const rc = new module.rcConfig();\n	rc.cs = parameters.cs;\n	rc.ch = parameters.ch;\n	rc.borderSize = parameters.borderSize ? parameters.borderSize : 0;\n	rc.tileSize = parameters.tileSize ? parameters.tileSize : 0;\n	rc.walkableSlopeAngle = parameters.walkableSlopeAngle;\n	rc.walkableHeight = parameters.walkableHeight;\n	rc.walkableClimb = parameters.walkableClimb;\n	rc.walkableRadius = parameters.walkableRadius;\n	rc.maxEdgeLen = parameters.maxEdgeLen;\n	rc.maxSimplificationError = parameters.maxSimplificationError;\n	rc.minRegionArea = parameters.minRegionArea;\n	rc.mergeRegionArea = parameters.mergeRegionArea;\n	rc.maxVertsPerPoly = parameters.maxVertsPerPoly;\n	rc.detailSampleDist = parameters.detailSampleDist;\n	rc.detailSampleMaxError = parameters.detailSampleMaxError;\n\n	if (!self.navMesh) {\n		self.navMesh = new module.NavMesh();\n	}\n	self.navMesh.build(positions, offset, indices, indicesLength, rc);\n\n	const navmeshData = navMesh.getNavmeshData();\n	const arrView = new Uint8Array(module.HEAPU8.buffer, navmeshData.dataPointer, navmeshData.size);\n	const ret = new Uint8Array(navmeshData.size);\n	ret.set(arrView);\n	navMesh.freeNavmeshData(navmeshData);\n\n	postMessage(ret);\n}\n"])), this._worker = new Worker(this._workerURL), this.whenWorkerReady = new Promise((t) => {
  ...
  getClosestPoint(t) {
    return Gt.x = t.x, Gt.y = t.y, Gt.z = t.z, this.navMesh.getClosestPoint(Gt);
  }
  getClosestPointToRef(t, e) {
    Gt.x = t.x, Gt.y = t.y, Gt.z = t.z;
    let i2 = this.navMesh.getClosestPoint(Gt);
    e.set(i2.x, i2.y, i2.z);
  }
  getRandomPointAround(t, e) {
    return Gt.x = t.x, Gt.y = t.y, Gt.z = t.z, this.navMesh.getRandomPointAround(Gt, e);
  }
  getRandomPointAroundToRef(t, e, i2) {
    Gt.x = t.x, Gt.y = t.y, Gt.z = t.z;
    let o = this.navMesh.getRandomPointAround(Gt, e);
    i2.set(o.x, o.y, o.z);
  }
  moveAlong(t, e) {
    return Gt.x = t.x, Gt.y = t.y, Gt.z = t.z, qt.x = e.x, qt.y = e.y, qt.z = e.z, this.navMesh.moveAlong(Gt, qt);
  }
  ...
  computePath(t, e) {
    ...
    let o = this.navMesh.computePath(Gt, qt), s = o.getPointCount(), n2 = [];
  ...
  setDefaultQueryExtent(t) {
    Gt.x = t.x, Gt.y = t.y, Gt.z = t.z, this.navMesh.setDefaultQueryExtent(Gt);
  }
  ...
  addCylinderObstacle(t, e, i2) {
    return Gt.x = t.x, Gt.y = t.y, Gt.z = t.z, this.navMesh.addCylinderObstacle(Gt, e, i2);
  }
  addBoxObstacle(t, e, i2) {
    return Gt.x = t.x, Gt.y = t.y, Gt.z = t.z, qt.x = e.x, qt.y = e.y, qt.z = e.z, this.navMesh.addBoxObstacle(Gt, qt, i2);
  }
  removeObstacle(t) {
...
O2({ setup: function(t) {
  ...
  if (c && d && (true === c.data.visible || true === c.data.physics.enabled)) {
    ...
    let h2 = new Zt(c, t.renderer.domElement, d, t.eventContext.page.data.globalPhysics, e, c.uuid !== i2.uuid && d.camera === i2.uuid, i2, e.page, t.sharedAssets);
...
//# sourceMappingURL=runtime-gameControls-JQ3GPIIQ-R2LK7PCE.js.map
