...
// node_modules/@splinetool/runtime/build/runtime-tracking-N5EXAGD3.js
var E = new Ki();
var f = new Ki();
var w2 = new Ki();
var y = new Ki();
var L = new mn();
var M = { type: "requestRender" };
var F = (function() {
...
var b = class extends s {
  ...
  updateSingleEvent(e2, t = false) {
    ...
    if (e2.object.getWorldPosition(w2), e2.isReset) y.copy(e2.worldPosition0);
      ...
      if ("custom" === n2 ? (e3().getWorldDirection(f), f.negate(), E.copy(f)) : "xy" === n2 ? E.set(0, 0, 1) : "xz" === n2 ? E.set(0, 1, 0) : "yz" === n2 && E.set(1, 0, 0), L.setFromNormalAndCoplanarPoint(E, w2), !t2.ray.intersectPlane(L, y)) return;
    }
    if (!e2.isReset) {
    ...
    let a3 = F(w2, y, e2.wasOutside ? 0 : e2.data.maxDelta);
    if (e2.currentDampingFactor > 1) {
      let n3 = E.subVectors(a3, w2).divideScalar(e2.currentDampingFactor);
      w2.add(n3), t && x(e2.object, w2), e2.paused = n3.length() < 0.01;
    } else x(e2.object, a3), e2.paused = true;
    (_a = e2.object) == null ? void 0 : _a.dispatchEvent({ type: "beginEvent", eventName: "Follow" }), e2.object.dispatchEvent(M);
  }
};
var R = new Ki();
var j2 = new Ki();
...
var W = { type: "changeRotation" };
var V = (function() {
  let e2 = new As();
  return function(n2, i) {
    null !== n2.parent ? e2.multiplyMatrices(n2.parent.matrixWorld, n2.hiddenMatrix) : e2.copy(n2.hiddenMatrix), i.premultiply($(e2).invert()), n2.rotation.setFromRotationMatrix(i), n2.updateMatrix(), n2 instanceof ie && j(n2.parent) && n2.invalidateDownstreamBooleanData(true);
  };
})();
var A = class {
...
var B = class extends s {
  ...
  connect() {
    ...
    if (e2.traverseEntity((t2) => {
      ...
      n3 && (!e2.data.globalPhysics.usePhysics || "dynamic" !== ((_b = t2.dataPatched.physics) == null ? void 0 : _b.rigidBody)) && this.events.push(new A(n3.data, n3.id, t2, e2));
    }), !this.events.length) return;
    let { domElement: t, eventElement: n2 } = this.eventContext;
  ...
  updateSingleEvent(e2) {
    ...
    if (h.getWorldPosition(O2), !e2.isReset) if (e2.target) e2.target.getWorldPosition(S);
    else {
      if ("custom" === s3 ? (l().getWorldDirection(j2), j2.negate(), T.setFromNormalAndCoplanarPoint(j2, O2)) : ("xy" === s3 ? R.set(0, 0, 1) : "xz" === s3 ? R.set(0, 1, 0) : "yz" === s3 && R.set(1, 0, 0), T.setFromNormalAndCoplanarPoint(R, O2)), !u.ray.intersectPlane(T, S)) return;
      i > 0 && ("custom" === s3 || void 0 === s3) && S.addScaledVector(j2, i);
    }
    if (e2.isReset || (c ? "target" === t ? k.copy(c.up).applyMatrix4(P.extractRotation(c.matrixWorld)).normalize() : o.some((e3) => false === e3) ? ("x" === n2 ? (Q.set(0, 0, 1), false === o[2] && Q.set(0, 1, 0)) : "y" === n2 ? (Q.set(1, 0, 0), false === o[0] && Q.set(0, 0, 1)) : (Q.set(0, 1, 0), false === o[1] && Q.set(1, 0, 0)), k.copy(Q).applyQuaternion(e2.worldQuaternion0).normalize()) : k.set(0, 1, 0) : "custom" === s3 ? k.set(0, 1, 0) : k.copy(R)), e2.isReset) N.copy(e2.worldQuaternion0);
    else if (O2.distanceTo(S) > a3 && r && c) {
      ...
      N.copy(e2.worldQuaternion0), e2.currentDampingFactor = e2.resetDampingFactor;
    } else {
      ...
      (function(e3, t2, n3, i2, s4, a4) {
        let o2 = P.elements;
        Z.subVectors(t2, n3), 0 === Z.lengthSq() && (Z.z = 1), Z.normalize(), U.crossVectors(i2, Z), 0 === U.lengthSq() && (1 === Math.abs(i2.z) ? Z.x += 1e-4 : Z.z += 1e-4, Z.normalize(), U.crossVectors(i2, Z)), U.normalize(), I.crossVectors(Z, U), "x" === s4 ? 1 === a4.z ? [U, I, Z] = [Z, U, I] : (U.negate(), [U, Z] = [Z, U]) : "y" === s4 ? 1 === a4.x ? [U, I, Z] = [I, Z, U] : (U.negate(), [I, Z] = [Z, I]) : 1 === a4.x && (U.negate(), [U, I] = [I, U]), o2[0] = U.x, o2[4] = I.x, o2[8] = Z.x, o2[1] = U.y, o2[5] = I.y, o2[9] = Z.y, o2[2] = U.z, o2[6] = I.z, o2[10] = Z.z;
      })(0, S, O2, k, n2, Q), N.setFromRotationMatrix(P), C.setFromUnitVectors(Q.applyQuaternion(N), k), o.some((e3) => false === e3) && "target" !== t && N.premultiply(C).normalize();
    }
    e2.currentDampingFactor > 1 ? (h.updateWorldMatrix(true, false), C.setFromRotationMatrix($(h.matrixWorld)), C.slerp(N, 1 / e2.currentDampingFactor), V(h, P.makeRotationFromQuaternion(C)), e2.paused = 8 * (1 - C.dot(N)) < 1e-6) : (V(h, P.makeRotationFromQuaternion(N)), e2.paused = true), (_a = e2.object) == null ? void 0 : _a.dispatchEvent({ type: "beginEvent", eventName: "LookAt" }), h.dispatchEvent(z), h.dispatchEvent(W);
  }
};
var I = new Ki();
var U = new Ki();
var Z = new Ki();
e("Follow", ({ eventContext: e2, eventManager: t }) => new b(e2, t)), e("LookAt", ({ eventContext: e2 }) => new B(e2)), a("tracking");
//# sourceMappingURL=runtime-tracking-N5EXAGD3-DL474X7G.js.map
