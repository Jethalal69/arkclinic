...
// node_modules/@splinetool/runtime/build/runtime-miscActions-HPVTGVUE.js
...
var y = { type: "completeState", isfromEntity: false };
var C2 = { type: "requestRender" };
var I = class extends Fi {
  ...
  buildAnimation(a2 = false) {
    ...
    let r = { duration: this.data.duration, delay: 0, delayDirection: "start-once", direction: "normal", repeat: 0, ease: Ce(this.data) }, s = (t3) => {
      let e2 = this.page.activeCamera;
      e2.position.lerpVectors(this.posStart, this.posEnd, t3), e2.quaternion.slerpQuaternions(this.qStart, this.qEnd, t3), e2.zoom = this.zoomStart + (this.zoomEnd - this.zoomStart) * t3, e2.wasMovedBySwitchCameraAction = true, e2.updateMatrix(), e2.updateMatrixWorld(), e2.updateProjectionMatrix(), e2.dispatchEvent(C2), 1 === t3 && e2.dispatchEvent(y);
    };
