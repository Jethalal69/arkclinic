...
// node_modules/@splinetool/runtime/build/runtime-chunk-AZB3ROBJ.js
var p = null;
function b(e) {
  p = e;
}
...
var q = class extends ie {
  ...
  update(e) {
    !this.simRunning || (this.pendingSimSeconds = Math.min(this.pendingSimSeconds + e / 1e3, 4 * C * 2), this.trackMotionRest(e / 1e3));
  }
  trackMotionRest(e) {
  ...
  buildRoots() {
    ...
    if (this.baseFoundAtRegen = false, this.baseSourceGeomsAtRegen = [], this.baseSourceHashesAtRegen = [], this.baseColorHashAtRegen = 0, this.baseScaleAtRegen = 0, "object" === e && t) {
      ...
      if (e2) {
        ...
        if (this.baseSourceGeomsAtRegen = (t2 == null ? void 0 : t2.sources.map((e3) => e3.geometry)) ?? [], this.baseSourceHashesAtRegen = (t2 == null ? void 0 : t2.hashes) ?? [], this.baseColorHashAtRegen = (t2 == null ? void 0 : t2.colorHash) ?? 0, t2 && i) {
          ...
          let h = r;
          return H({ shape: "object", guideStrands: s, hairLength: a, sampler: (e3) => {
            let t3 = i(e3);
    ...
    return H({ shape: "object" === e ? "sphere" : e, guideStrands: s, hairLength: a });
  }
...
//# sourceMappingURL=chunk-AN52QVIS.js.map
