...
// node_modules/@splinetool/runtime/build/runtime-text-WPZBMBKI.js
var m = class {
  constructor() {
...
v("TextGeometry", b), v("InputGeometry", b), Pe(class {
  ...
  generateShapes(t2, e2, r) {
    ...
    for (let h3 = 0; h3 < t2.length; h3++) {
      ...
      let b2 = this.computeSpaceWidthForLine(t2, h3, e2, r), P = 0, T = x2[0];
      T && 2 === e2.horizontalAlign && void 0 !== T.leftSideBearing && (c -= T.leftSideBearing * n);
      try {
...
//# sourceMappingURL=runtime-text-WPZBMBKI-DNJ6OO4Z.js.map
