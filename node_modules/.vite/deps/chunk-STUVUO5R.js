import {
  ...
  N,
  V as V2
} from "./chunk-TBSNN2RH.js";
import {
  r,
  u
} from "./chunk-JZWQ2H2N.js";
import {
  B,
  P,
  j
...
// node_modules/@splinetool/runtime/build/runtime-chunk-DL7X5N5X.js
var L2 = Math.fround;
var Q = [0.01, 100];
var Z = [0.01, 1e4];
var U = [0.01, 1e3];
...
function X(e2, t, r3, a, n) {
  e2 = K(e2, Q), t = K(t, Z), r3 = K(r3, U), a = K(a, H);
...
function re(e2, t, r3) {
  return L2(L2(L2(L2(L2(J(t, r3) * e2) + ee(t, r3)) * e2) + te(t)) * e2);
}
function ae(e2, t, r3) {
  let a = L2(L2(L2(3 * J(t, r3)) * e2) * e2), n = L2(L2(2 * ee(t, r3)) * e2);
...
function ie2(e2, t, r3, a) {
  ...
  for (let t2 = 0; t2 < 11; t2++) n[t2] = re(L2(t2 * _), e2, r3);
  return (i3) => 0 === (i3 = L2(i3)) || 1 === i3 ? i3 : re(((t2) => {
    let a2 = 0, i4 = 1;
    for (; 10 !== i4 && n[i4] <= t2; ) a2 = L2(a2 + _), i4 += 1;
    i4 -= 1;
    let s = L2(L2(t2 - n[i4]) / L2(n[i4 + 1] - n[i4])), o = L2(a2 + L2(s * _)), l = ae(o, e2, r3);
    return l >= Y ? (function(e3, t3, r4, a3) {
  ...
  return a.data.visible && g.push(...(function(e2, t, r3, a2, n2) {
    ...
    if (r2(e2) ? (i3 = we("position", e2, t, r3, n2), i3 && g2.push(i3), u2 = ge("rotation", e2, t, r3, n2), u2 && g2.push(u2), d2 = we("shear", e2, t, r3, n2), d2 && g2.push(d2)) : (f2 = { slide: ((_a = t.pathSnapping) == null ? void 0 : _a.slide) ?? ((_b = e2.updatedPathSnapping) == null ? void 0 : _b.slide) ?? ((_c = e2.dataPatched.pathSnapping) == null ? void 0 : _c.slide) ?? 0, offset: ((_d = t.pathSnapping) == null ? void 0 : _d.offset) ?? ((_e = e2.updatedPathSnapping) == null ? void 0 : _e.offset) ?? ((_f = e2.dataPatched.pathSnapping) == null ? void 0 : _f.offset) ?? 0 }, p2 = ge("slide", f2, t.pathSnapping ?? e2.updatedPathSnapping ?? e2.dataPatched.pathSnapping, r3.pathSnapping ?? e2.dataPatched.pathSnapping, n2), p2 && g2.push(p2), h = ge("offset", f2, t.pathSnapping ?? e2.updatedPathSnapping ?? e2.dataPatched.pathSnapping, r3.pathSnapping ?? e2.dataPatched.pathSnapping, n2), h && g2.push(h), !p2 && !h && (i3 = ye("position", e2, t, r3, n2), i3 && g2.push(i3), l = ye("scale", e2, t, r3, n2), l && g2.push(l), u2 = (function(e3, t2, r4, a3, n3) {
      ...
      let r4 = r2(e2) ? () => {
        ...
        var _a2;
        e2.updateMatrix(), e2.hasNonUniformScale && (e2.updateMatrixWorld(), e2.updateMatrixWorldRigid()), ((_a2 = e2.parent) == null ? void 0 : _a2.matrixWorldFusedFalse) && (e2.matrixWorld.multiplyMatrices(e2.parent.matrixWorldFusedFalse, e2.matrix), e2.matrixWorldNeedsUpdate = false), P(e2) && j(e2.parent) && e2.invalidateDownstreamBooleanData(true), e2.updatePathSnapping(Object.assign({}, t.pathSnapping, f2));
      };
      g2.push({ update: r4, start: r4, end: r4 });
    }
    return g2;
  })(a, n, d, p, c.shared)), r2(a) ? g.push(...(function(a2, n2, i3, s, o) {
    let l, u2, d2, c2, p2, h, f2, g2, m, b, y2, v, w, S, j2, V3 = [];
    if ("width" in a2 && (l = ge("width", a2, n2, i3, o), l && V3.push(l)), "height" in a2 && (u2 = ge("height", a2, n2, i3, o), u2 && V3.push(u2)), a2 instanceof L || a2 instanceof V2) {
      let t = { ...n2.fill }, r3 = { ...i3.fill };
      void 0 !== t.enabled && t.enabled !== r3.enabled && (V3.push(/* @__PURE__ */ (function(t2) {
        return { update: () => {
          t2 instanceof L && (t2.fill.enabled = true);
        } };
      })(a2)), t.enabled || Object.assign(t, { enabled: true, color: { ...t.color, a: 0 } }), r3.enabled || Object.assign(r3, { enabled: true, color: { ...r3.color, a: 0 } })), d2 = Se("color", a2.fill, t, r3, o), d2 && V3.push(d2);
    }
    if (a2 instanceof L) {
      let t = { ...n2.stroke }, r3 = { ...i3.stroke };
      (t.enabled || r3.enabled) && (V3.push(/* @__PURE__ */ (function(t2) {
        return { update: () => {
          t2 instanceof L && (t2.stroke.enabled = true);
        } };
      })(a2)), t.enabled || Object.assign(t, { enabled: true, color: { ...t.color, a: 0 } }), r3.enabled || Object.assign(r3, { enabled: true, color: { ...r3.color, a: 0 } })), c2 = Se("color", a2.stroke, t, r3, o), c2 && V3.push(c2), p2 = ge("thickness", a2.stroke, t, r3, o), p2 && V3.push(p2);
    }
    if (a2 instanceof L) {
      ...
      })(a2)), t.enabled || Object.assign(t, { enabled: true, color: { ...t.color, a: 0 } }), r3.enabled || Object.assign(r3, { enabled: true, color: { ...r3.color, a: 0 } })), h = Se("color", a2.dropShadow, t, r3, o), h && V3.push(h), f2 = ge("blurRadius", a2.dropShadow, t, r3, o), f2 && V3.push(f2), m = ge("spread", a2.dropShadow, t, r3, o), m && V3.push(m), g2 = we("offset", a2.dropShadow, t, r3, o), g2 && V3.push(g2);
    }
    if (a2 instanceof L) {
      ...
      })(a2)), t.enabled || Object.assign(t, { enabled: true, color: { ...t.color, a: 0 } }), r3.enabled || Object.assign(r3, { enabled: true, color: { ...r3.color, a: 0 } })), b = Se("color", a2.innerShadow, t, r3, o), b && V3.push(b), y2 = ge("blurRadius", a2.innerShadow, t, r3, o), y2 && V3.push(y2), w = ge("spread", a2.innerShadow, t, r3, o), w && V3.push(w), v = we("offset", a2.innerShadow, t, r3, o), v && V3.push(v);
    }
    if (a2 instanceof L || a2 instanceof V2) {
      let t = { ...n2.backgroundBlur }, r3 = { ...i3.backgroundBlur };
      (t.enabled || r3.enabled) && (V3.push(/* @__PURE__ */ (function(t2) {
        return { update: () => {
          t2 instanceof L && (t2.backgroundBlur.enabled = true);
        } };
      })(a2)), t.enabled || Object.assign(t, { enabled: true, radius: 0 }), r3.enabled || Object.assign(r3, { enabled: true, radius: 0 })), S = ge("radius", a2.backgroundBlur, t, r3, o), S && V3.push(S);
    }
    if (a2 instanceof L) {
      ...
      })(a2)), t.enabled || Object.assign(t, { enabled: true, radius: 0 }), r3.enabled || Object.assign(r3, { enabled: true, radius: 0 })), j2 = ge("radius", a2.layerBlur, t, r3, o), j2 && V3.push(j2);
    }
    if (a2 instanceof V2 || a2 instanceof N) {
    ...
    return n2;
  })(a, n, d, c.shared)) : a instanceof V && g.push(...(function(e2, t, r3, a2) {
    var _a, _b, _c, _d;
...
var Fe = { type: "completeState", isfromEntity: false };
function Ie(e2, t) {
  var _a;
  let r3, a;
...
var We = class {
  constructor(e2, t, r3, a, n, i3, s, o = {}, l = () => Te) {
    var u2;
    ...
    }, this.runner = new ue({ duration: (u2 = a).duration, ease: Ce(u2), ...Pe(u2) }, this.onChange, this.buildCallback), this.rebind();
  }
  rebind() {
    let { fromRef: e2, toRef: t } = this;
    if (void 0 === e2) {
      let e3 = Ie(this.object, this.object.currentState === t ? this.object.prevState : this.object.currentState);
      if (!e3) throw new Error("Missing property");
      this.from = e3;
    } else {
      let t2 = Ie(this.object, e2);
      if (!t2) throw new Error("Missing property");
      this.from = t2;
    }
    if (void 0 === t) throw new Error("Missing property");
    let r3 = Ie(this.object, t);
  ...
  writeState(e2) {
    ...
    a.settled === t && a.state === r3 || (this.object.transitionState = { settled: t, state: r3 }, this.object.reversibleToState = this.end.id, this.object.prevState !== this.object.currentState && (this.object.prevState = this.object.currentState), this.object.currentState = r3, this.object.dispatchEvent({ type: "transitionState", settled: t, state: r3 }), this.object.dispatchEvent({ type: t ? "completeState" : "beginState", state: r3 }), this.object.traverseEntity((e3) => {
      e3 !== this.object && e3 instanceof V && e3.dispatchEvent(t ? Fe : Ge);
...
//# sourceMappingURL=chunk-STUVUO5R.js.map
