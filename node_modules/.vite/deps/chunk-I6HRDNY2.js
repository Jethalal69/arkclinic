...
import {
  e as e2
} from "./chunk-JMJSRYJY.js";
import {
  V as V2
} from "./chunk-6BSVDP3P.js";
import {
  r as r3
} from "./chunk-TVZXKFID.js";
import {
  y
...
import {
  c as c3
} from "./chunk-NO2AEG7Q.js";
import {
  l
} from "./chunk-7KVDCTUM.js";
import {
  Xt,
  ar,
  cr,
...
// node_modules/@splinetool/runtime/build/runtime-chunk-3F6LVH6N.js
var St = null;
function Bt(t2) {
  St = t2;
}
...
var Lt = class extends Za {
  ...
  allocateAndStoreLocalSplatDataInTextures() {
    ...
    for (let e4 = 0; e4 < t2; e4++) {
      ...
      r4[s5] = Gt(this.colors[t3], this.colors[t3 + 1], this.colors[t3 + 2], this.colors[t3 + 3]), r4[s5 + 1] = Ut(this.centers[n4]), r4[s5 + 2] = Ut(this.centers[n4 + 1]), r4[s5 + 3] = Ut(this.centers[n4 + 2]);
    }
...
var Zt = false;
function Xt2() {
  if (!Zt) return Yt || (Yt = (async function() {
    let t2 = await import("./gaussian-splat-compression-N542LVSF.js");
    Qt(t2), Zt = true;
  })());
}
var Kt = new As();
...
function ue(n3, s4, i3) {
  ...
  return nt.is(s4.type) ? new V2(n3, s4) : (console.error(s4), new r2(n3, s4));
}
...
var Ae = class extends hr {
  ...
  updateInstanceGroups(t2, e3) {
    ...
    (null === n3 || n3.minGroupSize !== e3) && (n3 == null ? void 0 : n3.dispose(), n3 = new Nt(e3), this._autoInstancing = n3);
  ...
  needsTransmission() {
    return this.needsTransmissionDirty && (this._needsTransmission = W(this), this.needsTransmissionDirty = false), this._needsTransmission;
  }
  needsNormal() {
  ...
  needsReflection() {
    return this.needsReflectionDirty && (this._needsReflection = _(this), this.needsReflectionDirty = false), this._needsReflection;
  }
  ...
  updateTreeByOp(t2, e3) {
    ...
    if (0 === t2.path.length && 7 === t2.type) {
      ...
      s4.updateVisible(this), s4.resetBBoxNeedsUpdate(), P(s4) && j(s4.parent) && (s4.invalidateUpstreamBooleanData(), s4.parent.invalidateDownstreamBooleanData().recomputeBoolean()), this.markNeedsRecomputeInstancesForAncessors(n3), this.markNeedsRecomputeInstancesForChildren(s4), this.markToExpandCloner(s4), this.markPenumbraSizeDirty(), s4.updatePathSnapping();
      ...
      s4.children.splice(i3, 0, s4.children.pop()), P(e4) && (e4.invalidateUpstreamBooleanData(), j(e4.parent) ? e4.parent.invalidateDownstreamBooleanData().recomputeBoolean() : n3 instanceof F && n3.invalidateDownstreamBooleanData().recomputeBoolean()), e4.updatePathSnapping();
    }
  ...
  raycast1(t2, e3) {
    let n3 = [], s4 = (i3) => {
      for (let a3 of i3.children) {
        ...
        } else (P(a3) || k(a3) && this.enableHelpers && a3.objectHelper.visible) && (t2.intersectObject(a3, false, n3), J(a3, t2, n3)), s4(a3);
      }
    };
  ...
  raycastWithClones(t2) {
    let e3 = [], n3 = (s4) => {
      for (let i3 of s4.children) {
        let s5 = i3.cloner;
        mt.is(i3) && (i3.visible || (s5 == null ? void 0 : s5.object.data.visible)) && ((P(i3) || k(i3) && this.enableHelpers && i3.objectHelper.visible) && (t2.intersectObject(i3, false, e3), J(i3, t2, e3, true)), n3(i3));
      }
    };
    return n3(this), e3;
  }
  ...
  updateViewPlaneSize(t2, e3, n3 = false) {
    this.traverseConcreteEntity((s4) => {
      s4 instanceof V2 && s4.setViewplaneSize(t2, e3, n3);
    });
  }
...
//# sourceMappingURL=chunk-I6HRDNY2.js.map
